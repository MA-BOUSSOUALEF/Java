...
public class Adresse {
	 ...
	 */
		...
		private long numero=AUCUN_NUMERO;
		 ...
		 * renseignée.
		 * @param numero2 le numéro de la rue s'il existe, sinon Adresse.INUTILE
		 ...
		 */
		public Adresse(long numero2, String rue,String code_postal, String ville){
		 ...
		 */
		public final void  setNumero(long numero2) {
			if (((numero==AUCUN_NUMERO)||(numero==INUTILE_NUMERO))&&(numero2>0)) numero = numero2;
